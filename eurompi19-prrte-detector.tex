...
Recently, we proposed a deterministic failure detectors based on network overlays~\cite{George16}, where each participant only observes a  observation ring based detector for HPC systems.
