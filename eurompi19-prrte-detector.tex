...
Recently, we proposed a deterministic failure detectors based on network overlays~\cite{George16}, where each participant only observes a single peer, and the observation ring based detector for HPC systems.
