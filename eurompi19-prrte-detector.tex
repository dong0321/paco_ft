...
Recently, we proposed a deterministic failure detectors based on network overlays~\cite{George16}, where each peer only observ observation ring based detector for HPC systems.
