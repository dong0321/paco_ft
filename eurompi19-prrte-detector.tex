...
Notable efforts have been made for fault-tolerant communication based on logical network typologies. A fully connected topology can handle large number of failures but it cannot be scalable since it sends too many messages. At the other extreme, a ring topology is good for scalability
