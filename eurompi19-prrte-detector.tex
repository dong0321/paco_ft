...
\textbf{Reported$_i$}: initially empty \Comment{Set of failed process identifiers 
previously reported, local to daemon \textbf{i}}\newline
...
\begin{equation}
Overhead = \frac{ DAEMON^\#\_LAT - PRRTE\_LAT }{PRRTE\_LAT}
\end{equation}
...
In this section, we present the user case of the \ourwork.
