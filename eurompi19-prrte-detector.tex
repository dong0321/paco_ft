...
Gossip-style~\cite{infection-style,Abhinandan02} dissemination mechanisms emulate the spread of gossip in society. Initially, members are inactive except one member is aware of failure and need to propagate the update information. It propagates this information by randomly ping other members until it meets who already get notified. Notified members use the same propagation strategy to propagate this information in the group. This Gossip-style is resilient to process failure and spreads exponentially quickly in the group.     
