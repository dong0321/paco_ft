...
data exchanges between applications running independently. DataSpcae targets MPI based applications in which case the reliability comes from MPI implementations.  
