...
A more recent effort is k-nomial circulant graph~\cite{Angskun07, Pava11} which is a balance between the previous two methods. %In a k-nomial circulant graph, the diameter is defined as the longest shortest path between any two nodes in the graph.\todo{this sentence is self evident, need to review the full def on k-nomial}
