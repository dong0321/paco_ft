...
or in complement, a daemon may in also deploy a watchdog mechanism~\cite{pmix-watchdog} 
...
We arrange all N daemons to a logistic ring topology, as in Figure~\ref{fig:Ring}.
